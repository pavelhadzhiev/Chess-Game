...
void Pawn::move(int row, int col, int newRow, int newCol, Board& chess)
{
    ...
    {
        if((row+1==newRow && col==newCol && chess.isFree(newRow,newCol)) || (row==1 && newRow==3 && col==newCol && chess.isFree(newRow,newCol)))
        {
    ...
    {
        if((row-1==newRow && col==newCol && chess.isFree(newRow,newCol)) || (row==6 && newRow==4 && col==newCol && chess.isFree(newRow,newCol)))
        {
